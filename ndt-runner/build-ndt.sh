...
cd /home/pi/mlab-ndt/ndt/I2util && ./bootstrap.sh && ./configure && make && make install
cd /home/pi/mlab-ndt/ndt && ./bootstrap && ./configure && make
cd /home/pi/
...
mv /home/pi/mlab-ndt/ndt/src/web100clt /opt/web100clt
ln -s /opt/web100clt /usr/local/bin/web100clt

# Install required python libraries
cd /home/pi/mlab-ndt/ndt-runner
...
cd /home/pi/mlab-ndt/pt-analysis
python main.py
cp *.csv /home/pi/mlab-ndt/dashboard/data/

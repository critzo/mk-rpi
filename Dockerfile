...
RUN apt-get update
RUN apt-get install -qy git wget build-essential dh-autoreconf autoconf automake libtool gcc gcc-6 g++-6 libc++-dev make libssl-dev libevent-dev libgeoip-dev python python-dev python-setuptools pypy python-pip paris-traceroute screen

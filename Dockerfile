...
RUN apt-get update && apt-get install -y git wget dh-autoreconf autoconf automake libtool gcc-5 make libssl-dev libevent-dev libgeoip-dev python python-pip paris-traceroute screen
